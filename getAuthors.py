...
getit = 'http://api.elsevier.com/content/search/author?query=AUTHLASTNAME%28Torney%29&apiKey=' + config['apikey']
getit = 'http://api.elsevier.com/content/search/author?co-author=24588214300&apiKey=' + config['apikey']
co-author='AUTHOR_ID:24588214300'
aa= requests.get(getit)
bb=aa.json()

hello = pd.DataFrame.from_dict(bb, orient='index')
my_auth = ElsAuthor(uri = 'http://api.elsevier.com/content/search/author?query=AUTHLASTNAME%28Torney%29')
